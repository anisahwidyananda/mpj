      ...
      <div class="panel panel-flat col-md-12">
          ...
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold">Lihat Grafik Perminggu</legend>
    ...
    <?php 
      ...
      if (isset($data)) {
        foreach ($data as $key => $value) {
          $plan[] = (float) $value->progress_plan;
          $actual[] = (float) $value->progress_actual;
          $nama[] = $value->progress_nama." ".DATE("F",strtotime($value->progress_tanggal_mulai));
        }
      }
    ?>
